...
def web_search(query: str, max_results: int = 5, max_retries: int = 2) -> str:
    ...
    for attempt in range(max_retries):
        try:
            ...
            # Use longer timeout and keep-alive
            with httpx.Client(timeout=httpx.Timeout(15.0, connect=5.0)) as client:
                ...
                if response.status_code == 401:
                    ...
                    print(
                        f"[SEARCH] Check your API key at: https://serper.dev/dashboard"
                    )
                    return ""
                ...
                if response.status_code != 200:
                    ...
                    if attempt < max_retries - 1:
                        print(
                            f"[SEARCH] Retrying... (attempt {attempt + 2}/{max_retries})"
                        )
                        time.sleep(1)
                        continue
                    return ""
                ...
                formatted = "===================================================\n"
                formatted += "[WEB] LIVE WEB SEARCH RESULTS (CURRENT INFORMATION)\n"
                formatted += "===================================================\n"
